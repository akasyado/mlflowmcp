...
if user_text:
    ...
    # refined_query = run_async(st.session_state.assistant.llm_call(user_text))
    # st.session_state.history.append(HumanMessage(content=refined_query))
...
#         st.session_state.history = run_async(
#             st.session_state.assistant.ask(st.session_state.history, on_token=on_token)
#         )
